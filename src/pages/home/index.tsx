                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xl-2 col-lg-3 col-8">
                            <div className="logo">
                                <a className="logo-text-white" onClick={()=>nav2Home(navigate)}>
                                  <img src="/assets/img/logo/logo.png" alt="" style={{width:150}}/>
                                </a>
                                <a className="logo-text-black" onClick={()=>nav2Home(navigate)}>
                                  <img src="/assets/img/logo/logo-2.png" alt="" style={{width:150}}/>
                                </a>
                            </div>
                        </div>
                                ...
                                <div className="main-menu">
                                    <nav id="mobile-menu">
                                        <ul>
                                            ...
                                            <li><a href="#feature">产品特色</a></li>
                                            <li><a href="#version">经典版本</a></li>
                                            <li ><a href="">更新日志</a></li>
                                            <li ><a href="">使用指南</a></li>
                                        </ul>
                                    </nav>
                            ...
                            <div className="service-box-single mb-40">
                                <div className="service-box-content">
                                    ...
                                    <div className="service-box-content-text">
                                        ...
                                        <p>支持自建用户池，包含新增用户/部门/角色，删除用户/部门/角色，修改用户权限/部门/角色等基本功能，也支持用户更换部门/角色以及由此带来的一整套变更。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="service-box-single mb-40">
                                <div className="service-box-content">
                                    ...
                                    <div className="service-box-content-text">
                                        ...
                                        <p>用户可以自由选择一种或多种诸如用户名/密码登录，手机验证码登录，以及第三方IDP厂商账号登录，也支持滑动条/验证码等高级功能限制用户登录频次。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="service-box-single mb-40">
                                <div className="service-box-content">
                                    ...
                                    <div className="service-box-content-text">
                                        ...
                                        <p>对于已经完成身份认证的用户，提供细粒度的接口鉴权，支持RBAC模式以及角色政策，确保拥有对应权限的用户才能使用指定的接口进行符合要求的操作。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="service-box-single mb-40">
                                <div className="service-box-content">
                                    ...
                                    <div className="service-box-content-text">
                                        ...
                                        <p>支持要求用户提供两个或多个不同类型的凭据（知识因子/持有因子/生物因子）来证明身份，防止账户被盗，提高数据安全性。在企业账户中，MFA已成为必备安全措施</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="service-box-single mb-40">
                                <div className="service-box-content">
                                    ...
                                    <div className="service-box-content-text">
                                        ...
                                        <p>员工只需要登录一次，就能访问多个企业应用（比如邮件、文档、CRM、财务系统等），通过统一身份认证，提高安全性，方便 IT 部门控制权限，防止未经授权的访问。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
                            <div className="service-box-single mb-40">
                                <div className="service-box-content">
                                    ...
                                    <div className="service-box-content-text">
                                        <h4><a href="service-details.html">日志监控</a></h4>
                                        <p>实时收集、分析用户的行为日志，帮助企业发现问题、排查故障、检测异常行为，提高系统稳定性和安全性。它能自动告警，让运维团队第一时间发现异常。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div className="choosing__text">
                                                <h5>极致的用户体验</h5>
                                                <p>提供高颜值的交互页面，避免过多中间跳转，也可以通过简单的配置自定义主题风格，所见即所得，所得即所需。</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div className="choosing__number">
                                        ...
                                        <li>
                                            ...
                                            <div className="choosing__text">
                                                <h5>一键部署开箱即用</h5>
                                                <p>云原生无缝对接云端部署，也支持本地部署。简单的页面傻瓜式操作几分钟即可搭建企业级身份认证系统。</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div className="row g-0">
                                        <div className="col-lg-4 col-md-6">
                                            <div className="single-pricing mb-10">
                                                <div className="pricing-title">
                                                    <h5>社区版</h5>
                                                    <img src='/assets/img/vip/vip0.png' style={{height:50}}/>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="single-pricing mb-30">
                                                <div className="pricing-title">
                                                    <h5>旗舰版</h5>
                                                    <img src='/assets/img/vip/vip1.png' style={{height:50}}/>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="single-pricing mb-30">
                                                <div className="pricing-title">
                                                    <h5>企业版</h5>
                                                    <img src='/assets/img/vip/vip2.png' style={{height:50}}/>
                    ...
                    <div className="row wow fadeInUp">
                        <div className="col-lg-4 col-md-6">
                            <div className="footer-widget mb-40">
                                ...
                                <p>致力于用最新的技术手段打造极致体验的行业标准，让科技成为生产力，为企业个人提供便利有效的解决方案</p>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="footer-widget mb-40">
                                ...
                                <form className="subscribe-form mb-30 st-2">
                                    ...
                                    <button type="submit" style={{paddingTop: 0}}><i className="fas fa-paper-plane"></i>订阅</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row wow fadeInUp align-items-center">
                        <div className="col-lg-6 col-md-6">
                            <div className="copyright-text st-2">
                                <p>&copy; <script>document.write(new Date().getFullYear());</script> 作者：進撃の巴图鲁 亚马逊云科技&nbsp;&nbsp;IBT团队技术工程师</p>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6">
